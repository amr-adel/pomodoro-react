    ...
    <>
      <div className='about'>
        ...
        <p className='text'>
          ...
          Front End Libraries Certification, which requires using a frontend framework (like React for example) to build
          a Pomodoro Clock. the project must fulfill all the user stories and get all the tests passed.
        </p>
        
        <p className='text'>In this project, I'm using</p>
        <p className='text'>
